public class ReflectingActivity : Activity
{
    ...
    public ReflectingActivity(): base ("Reflecting", "This activity will help you reflect on times in your life when you have shown strength and resilience. This will help you recognize the power you have and how you can use it in other aspects of your life.", 30)
    {
    ...
    public string GetRandomQuestion()
    {
        ...
        Random random = new Random();
        int randomQuestion = random.Next(_unusedQuestions.Count);
        string question = _unusedQuestions[randomQuestion];
        _unusedQuestions.RemoveAt(randomQuestion);
        return question;
    }
